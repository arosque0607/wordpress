...
function computer_repair_services_page_redirection() {
	global $pagenow;
		if (isset($_GET['activated']) && ('themes.php' == $pagenow) && is_admin()) {
		wp_safe_redirect(admin_url("themes.php?page=computer-repair-services-info.php"));
	}
}
add_action('after_setup_theme', 'computer_repair_services_page_redirection');
